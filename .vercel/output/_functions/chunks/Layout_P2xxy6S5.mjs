import { c as createComponent, b as addAttribute, a as renderTemplate, s as spreadAttributes, u as unescapeHTML, j as defineScriptVars, h as createAstro, r as renderComponent, F as Fragment, d as renderScript, k as renderHead, i as renderSlot } from './astro/server_CmjTqM-c.mjs';
import 'kleur/colors';
/* empty css                                */
import { b as getAsset, U as UI, d as getCanonical, I as I18N, S as SITE, M as METADATA } from './permalinks_DzWyXSFW.mjs';
import 'clsx';
import merge from 'lodash.merge';
import { escape } from 'html-escaper';
import { b as getImage } from './_astro_assets_B_v-zovZ.mjs';
...
}, "/workspace/src/components/common/CommonMeta.astro", void 0);
...
const appleTouchIcon = new Proxy({"src":"/_astro/apple-touch-icon.DHIlG7dp.png","width":180,"height":180,"format":"png"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "/workspace/src/assets/favicons/apple-touch-icon.png";
							}
...
}, "/workspace/src/components/Favicons.astro", void 0);
...
const $$CustomStyles = createComponent(($$result, $$props, $$slots) => {
  ...
  :root {
    ...
    /* LARGO Monochrome 3-Color Palette */
    --largo-black: #000000;
    --largo-gray: #9c9c9c;
    --largo-white: #ffffff;

    /* Apply LARGO colors to theme variables */
    --aw-color-primary: var(--largo-black);
    --aw-color-secondary: var(--largo-gray);
    --aw-color-accent: var(--largo-gray);

    --aw-color-text-heading: var(--largo-black);
    --aw-color-text-default: var(--largo-black);
    --aw-color-text-muted: var(--largo-gray);
    --aw-color-bg-page: var(--largo-white);

    --aw-color-bg-page-dark: var(--largo-black);

    ::selection {
      background-color: var(--largo-gray);
      color: var(--largo-white);
    }
  }
  ...
  .dark {
    ...
    /* LARGO colors for dark mode */
    --aw-color-primary: var(--largo-white);
    --aw-color-secondary: var(--largo-gray);
    --aw-color-accent: var(--largo-gray);

    --aw-color-text-heading: var(--largo-white);
    --aw-color-text-default: var(--largo-white);
    --aw-color-text-muted: var(--largo-gray);
    --aw-color-bg-page: var(--largo-black);

    ::selection {
      background-color: var(--largo-gray);
      color: var(--largo-black);
    }
  }
</style>`;
}, "/workspace/src/components/CustomStyles.astro", void 0);
...
}, "/workspace/src/components/common/ApplyColorMode.astro", void 0);
...
}, "/workspace/node_modules/@astrolib/seo/src/AstroSeo.astro", void 0);
...
const load = async function() {
  let images = void 0;
  try {
    images = /* #__PURE__ */ Object.assign({"/src/assets/images/app-store.png": () => import('./app-store_DSEsdkaI.mjs'),"/src/assets/images/default.png": () => import('./default_DiEWxmUd.mjs'),"/src/assets/images/google-play.png": () => import('./google-play_BQxJEcrV.mjs'),"/src/assets/images/hero-image.png": () => import('./hero-image_DJIsJ4S6.mjs')});
  } catch (error) {
  }
  return images;
};
...
}, "/workspace/src/components/common/Metadata.astro", void 0);
...
}, "/workspace/src/components/common/SiteVerification.astro", void 0);
...
}, "/workspace/node_modules/@astrolib/analytics/src/GoogleAnalytics.astro", void 0);

const $$Analytics = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${null}`;
}, "/workspace/src/components/common/Analytics.astro", void 0);
