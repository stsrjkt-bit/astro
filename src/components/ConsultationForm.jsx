...
const TIME_SLOTS = [
  ...
  "17:00〜17:55", "18:00〜18:55", "19:00〜19:55", "20:00〜20:55",
];
  ...
  if (submitStatus === 'success') {
    return (
      <div className="bg-white border border-[#009DE0]/20 rounded-2xl p-10 text-center max-w-2xl mx-auto my-10 shadow-xl animate-fade-in relative overflow-hidden">
        ...
        <br />
        <a href="/" className="inline-block text-[#009DE0] font-bold hover:text-[#008ac4] underline hover:no-underline transition-all cursor-pointer">
          トップページへ戻る
        </a>
      </div>
    );
        ...
        <form onSubmit={handleSubmit} className="space-y-12">
          ...
          <div className="space-y-8 px-2">
            ...
            <div className="group">
              ...
              <textarea name="message" id="message" rows="5" required placeholder="「数学のテストが30点台で...」「理系に行きたいけど物理が不安」など、簡単で構いませんのでご記入ください。" className="w-full px-4 py-4 rounded-xl bg-[#F8FAFC] border-2 border-[#334455]/10 focus:bg-white focus:border-[#009DE0] outline-none resize-y transition-all shadow-sm"></textarea>
            </div>
          </div>
          ...
          <div className="pt-6">
            ...
            <p className="text-center text-sm text-[#334455]/60 mt-6 leading-relaxed">
              ご入力いただいたメールアドレス宛に、<br className="md:hidden"/>予約完了の自動返信メールが送信されます。
            </p>
          </div>
        </form>
      </div>
