...
import { MapPin, Calendar, Clock, ArrowRight, ChevronRight, ExternalLink, ChevronLeft, CheckCircle2, MessageCircle, GraduationCap, ChevronDown, Mail } from 'lucide-react';
  ...
  return (
    <div className="md:hidden px-6 py-8 bg-white/50 border-y border-[#009DE0]/10 backdrop-blur-sm">
      ...
      <div className="grid grid-cols-2 gap-3">
        {SECTIONS.slice(1, -1).map((section) => ( // TopとContact以外を表示
          <a 
            key={section.id} 
            href={`#${section.id}`}
      ...
      <div className="w-full overflow-hidden">
        ...
        */}
        <section id="top" className="relative w-full min-h-[90vh] flex items-center overflow-hidden">
          ...
          <div className="relative z-10 w-full max-w-6xl mx-auto px-6 md:px-12" style={{ transform: `translateY(${-scrollY * 0.1}px)` }}>
            <div className="max-w-2xl text-left">
              ...
              <div className={`transition-all duration-1000 delay-500 ${loaded ? 'opacity-100 translate-y-0 blur-0' : 'opacity-0 translate-y-8 blur-sm'}`}>
                <h2 className="font-serif text-3xl sm:text-5xl md:text-7xl leading-tight md:leading-snug text-[#334455] mb-10 md:mb-12 drop-shadow-sm tracking-tight">
                  <span className="inline-block whitespace-nowrap">数学が苦手でも、</span><br />
                  <span className="inline-block whitespace-nowrap">
                    <span className="text-[#009DE0] relative inline-block">
                      理系
                      <svg className="absolute w-full h-2 md:h-3 -bottom-1 left-0 text-[#D6DE26]/30 -z-10" viewBox="0 0 100 10" preserveAspectRatio="none">
              ...
              {/* CTA Button */}
              <div className={`mt-10 md:hidden transition-all duration-1000 delay-900 ${loaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
                 <a href="#gallery" className="inline-flex items-center gap-2 px-6 py-3 bg-[#009DE0] text-white rounded-full text-sm font-bold shadow-lg hover:bg-[#008ac4] transition-colors">
          ...
          <div className={`absolute bottom-10 left-1/2 transform -translate-x-1/2 transition-opacity duration-1000 delay-1000 ${loaded ? 'opacity-100' : 'opacity-0'}`}>
            <div className="animate-bounce text-[#009DE0]/50 p-4 cursor-pointer hover:text-[#009DE0] transition-colors flex flex-col items-center gap-2" onClick={() => window.scrollTo({top: window.innerHeight, behavior: 'smooth'})}>
            ...
            <Reveal>
              <div className="text-center mb-12">
                <h3 className="font-serif text-xl md:text-2xl text-[#334455] leading-relaxed">
                  「理系に行きたいけれど、<br className="md:hidden"/>数学が...」<br />
            ...
            <Reveal delay={400}>
              <div className="text-center mt-12">
                <p className="text-[#334455]/80 leading-loose text-sm md:text-base">
                  もし一つでも当てはまるなら、さとう数理塾にお任せください。<br />
          ...
          <div className="max-w-5xl mx-auto px-6">
            <Reveal>
              <div className="text-center mb-16 md:mb-24">
                <h3 className="font-serif text-2xl md:text-3xl text-[#009DE0] mb-2 font-bold">
                  3つの特徴
                </h3>
            ...
            <div className="grid md:grid-cols-3 gap-8 md:gap-12">
              ...
              <Reveal delay={100} className="h-full">
                <div className="bg-white p-8 md:p-10 rounded-lg relative group hover:shadow-xl hover:-translate-y-2 transition-all duration-500 h-full border border-[#009DE0]/10 hover:border-[#009DE0]/30 overflow-hidden shadow-sm">
                  ...
                  <div className="text-4xl text-[#009DE0] font-serif absolute top-6 right-6 transition-colors duration-500 z-10 opacity-50 font-bold">01</div>
                  
                  <h4 className="font-serif text-xl text-[#334455] mb-6 pt-4 relative z-10 font-bold">
                    個別対応
                  </h4>
              ...
              <Reveal delay={300} className="h-full">
                <div className="bg-white p-8 md:p-10 rounded-lg relative group hover:shadow-xl hover:-translate-y-2 transition-all duration-500 h-full border border-[#009DE0]/10 hover:border-[#009DE0]/30 overflow-hidden shadow-sm">
                  ...
                  <div className="text-4xl text-[#009DE0] font-serif absolute top-6 right-6 transition-colors duration-500 z-10 opacity-50 font-bold">02</div>
              ...
              <Reveal delay={500} className="h-full">
                <div className="bg-white p-8 md:p-10 rounded-lg relative group hover:shadow-xl hover:-translate-y-2 transition-all duration-500 h-full border border-[#009DE0]/10 hover:border-[#009DE0]/30 overflow-hidden shadow-sm">
                  ...
                  <div className="text-4xl text-[#009DE0] font-serif absolute top-6 right-6 transition-colors duration-500 z-10 opacity-50 font-bold">03</div>
                    ...
                    <div className="bg-white p-8 rounded-lg border-t-4 border-[#009DE0] shadow-sm h-full relative overflow-hidden hover:-translate-y-1 transition-transform duration-300">
                        ...
                        <ul className="space-y-4 relative z-10">
                            {['東北大学', '東京理科大学', '芝浦工業大学', '立命館大学'].map((school, i) => (
                                <li key={i} className="flex items-center gap-3 text-[#334455] font-medium border-b border-dashed border-gray-100 pb-2 last:border-0">
          ...
          <div className="max-w-4xl mx-auto px-6 relative z-10">
            <div className="grid md:grid-cols-2 gap-16">
              ...
              <Reveal>
                <div>
                  ...
                  <dl className="space-y-8 text-sm md:text-base">
                    <div className="group">
                      <dt className="text-xs text-[#334455]/60 mb-1 block tracking-widest group-hover:text-[#009DE0] transition-colors font-bold">教室名</dt>
                      <dd className="font-medium text-[#334455]">さとう数理塾</dd>
                    </div>
                    
                    <div className="group">
                      <dt className="text-xs text-[#334455]/60 mb-1 block tracking-widest group-hover:text-[#009DE0] transition-colors font-bold">住所</dt>
                      <dd className="flex items-start gap-2 text-[#334455] leading-relaxed">
                        <MapPin size={18} className="mt-1 flex-shrink-0 text-[#009DE0]" />
                        <span>〒410-0052<br/>静岡県沼津市沢田町1-3 牧原ビル102</span>
                      </dd>
                    </div>

                    <div className="grid grid-cols-2 gap-4">
                      <div className="group">
                        <dt className="text-xs text-[#334455]/60 mb-1 block tracking-widest group-hover:text-[#009DE0] transition-colors font-bold">開校日</dt>
                        <dd className="text-[#334455]">月〜金</dd>
                      </div>
                      <div className="group">
                        <dt className="text-xs text-[#334455]/60 mb-1 block tracking-widest group-hover:text-[#009DE0] transition-colors font-bold">開校時間</dt>
                    ...
                    <div className="group">
                      <dt className="text-xs text-[#334455]/60 mb-1 block tracking-widest group-hover:text-[#009DE0] transition-colors font-bold">休校日</dt>
                      <dd className="text-[#334455] leading-relaxed">
                        土日・8月のお盆・年末年始
                        <span className="block text-xs text-[#334455]/60 mt-2">※ 詳しい休校日程は下記の「今月のお休み（Googleカレンダー）」からご確認ください。</span>
                      </dd>
                    </div>
                  </dl>
                </div>
              ...
              <div className="flex flex-col justify-center space-y-4">
                <Reveal delay={200}>
                  <a href="#" className="group flex items-center justify-between p-6 border border-[#009DE0]/20 bg-white hover:border-[#009DE0] hover:shadow-md transition-all duration-300 transform hover:-translate-x-1 relative overflow-hidden rounded-lg shadow-sm">
                    <div className="flex items-center gap-4">
                      <div className="p-2 bg-[#009DE0]/10 rounded-full group-hover:bg-[#009DE0] transition-colors duration-300">
                         <Calendar className="text-[#009DE0] group-hover:text-white transition-colors" strokeWidth={1.5} size={20} />
                      </div>
                      <span className="text-sm md:text-base font-bold text-[#334455]">
                        今月のお休みを<br className="md:hidden"/> Googleカレンダーで見る
                      </span>
                    </div>
                ...
                <Reveal delay={300}>
                  <a href="#" className="group flex items-center justify-between p-6 border border-[#009DE0]/20 bg-white hover:border-[#009DE0] hover:shadow-md transition-all duration-300 transform hover:-translate-x-1 relative overflow-hidden rounded-lg shadow-sm">
                    <div className="flex items-center gap-4">
                       <div className="p-2 bg-[#009DE0]/10 rounded-full group-hover:bg-[#009DE0] transition-colors duration-300">
                        <MapPin className="text-[#009DE0] group-hover:text-white transition-colors" strokeWidth={1.5} size={20} />
                      </div>
                      <span className="text-sm md:text-base font-bold text-[#334455]">
                        Googleマップで<br className="md:hidden"/> 教室の場所を見る
                      </span>
                    </div>
                    <ExternalLink size={18} className="text-[#009DE0]/50 group-hover:text-[#009DE0]" />
                  </a>
            ...
            <div className="max-w-4xl mx-auto px-6 relative z-10 text-center">
                <Reveal>
                    <h3 className="font-serif text-xl md:text-2xl text-[#334455] mb-6 leading-relaxed">
                        ...
                        <span className="text-sm md:text-base text-[#334455]/80 mt-4 block font-sans">
                            まずは不安を解消し、新しい可能性を見つける場として、<br className="md:hidden" />無料体験・相談をご活用ください。
                        </span>
                    </h3>
                </Reveal>
                ...
                <Reveal delay={200}>
                    <div className="flex flex-col md:flex-row gap-4 justify-center mt-10">
                        ...
                        {/* LINE Button */}
                        <a href="#" className="group flex items-center justify-center gap-3 px-8 py-4 bg-[#06C755] text-white rounded-full shadow-lg hover:bg-[#05b04d] hover:shadow-xl hover:-translate-y-1 transition-all duration-300 font-bold text-base md:text-lg min-w-[280px]">
