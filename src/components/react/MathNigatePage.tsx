...
import { 
  ...
  AlertCircle, HeartHandshake, BrainCircuit, LineChart,
  MessageCircle, GraduationCap, Mail
} from 'lucide-react';
            ...
            <div className="max-w-3xl text-left">
              ...
              <div className={`transition-all duration-1000 delay-500 ${loaded ? 'opacity-100 translate-y-0 blur-0' : 'opacity-0 translate-y-8 blur-sm'}`}>
                <h2 className="font-serif text-2xl sm:text-4xl md:text-5xl leading-tight md:leading-snug text-[#334455] mb-8 drop-shadow-sm tracking-tight">
                  「数学が心配...」<br className="md:hidden"/>その不安は、<br/>
                ...
                <p className="text-[#334455]/80 text-base md:text-lg leading-loose mb-10 max-w-2xl">
                  お子様の数学の点数を見て、将来の進路を諦めかけてはいませんか？<br/>
                  高校数学は一度つまずくと挽回が難しい教科ですが、<br className="hidden md:block"/>
                  原因を特定し、正しい順序で学び直せば、必ず自信を取り戻せます。<br/>
              ...
              <div className={`transition-all duration-1000 delay-700 ${loaded ? 'opacity-100 translate-y-0 blur-0' : 'opacity-0 translate-y-8 blur-sm'}`}>
                <div className="flex flex-col sm:flex-row gap-4">
                  ...
                  <a href="#worry" className="inline-flex justify-center items-center gap-2 px-8 py-4 bg-white text-[#334455] border border-[#334455]/10 rounded-full text-sm font-bold shadow-sm hover:bg-gray-50 transition-all">
          ...
          <div className="max-w-4xl mx-auto px-6">
            <Reveal>
              <div className="text-center mb-12">
                <span className="text-[#009DE0] font-bold text-sm tracking-widest uppercase mb-2 block">Check List</span>
                <h3 className="font-serif text-xl md:text-3xl text-[#334455] leading-relaxed font-bold">
                  こんなご様子に、<br className="md:hidden"/>心当たりはありませんか？
                </h3>
              </div>
            </Reveal>
              ...
              <Reveal delay={600}>
                <div className="mt-10 text-center">
                  <p className="text-[#334455]/80 leading-relaxed">
                    これらは、決して「お子様の努力不足」や「能力の問題」だけが原因ではありません。<br className="hidden md:block"/>
                    高校数学特有の<strong className="text-[#009DE0] font-bold">「構造的な難しさ」</strong>が壁になっているケースがほとんどです。
                  </p>
                </div>
              </Reveal>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <Reveal delay={100} className="h-full">
                <div className="h-full bg-white p-8 rounded-lg border-t-4 border-[#009DE0] shadow-sm relative overflow-hidden group">
                  ...
                  <p className="text-[#334455]/80 text-sm leading-7 relative z-10">
                    数学は「ピラミッド」のような科目です。高1の内容でつまずいたまま高2の内容を理解することは、土台のない場所に家を建てるようなもの。<br/>
                    <span className="border-b border-[#D6DE26] font-bold">どこから崩れているか</span>を特定しない限り、今の授業を聞いても理解できません。
                  </p>
                </div>
              </Reveal>
              ...
              <Reveal delay={200} className="h-full">
                <div className="h-full bg-white p-8 rounded-lg border-t-4 border-[#D6DE26] shadow-sm relative overflow-hidden group">
                  ...
                  <p className="text-[#334455]/80 text-sm leading-7 relative z-10">
                    授業で先生の解説を聞いて「なるほど」と思っても、それは「理解した」だけ。<br/>
                    「自力で解ける」状態にはなっていません。<br/>
                    このギャップがテスト本番での<span className="border-b border-[#D6DE26] font-bold">「手が動かない」</span>を引き起こします。
                  </p>
                </div>
              </Reveal>
              ...
              <Reveal delay={300} className="h-full">
                <div className="h-full bg-white p-8 rounded-lg border-t-4 border-[#EA5514] shadow-sm relative overflow-hidden group">
                  ...
                  <p className="text-[#334455]/80 text-sm leading-7 relative z-10">
                    「復習しなさい」と言われても、生徒本人は<span className="border-b border-[#D6DE26] font-bold">「どの単元の、何がわからないのか」</span>がわかりません。<br/>
        ...
        */}
        <section id="solution" className="py-20 md:py-32 bg-[#F1F5F9] relative">
          <div className="max-w-5xl mx-auto px-6">
            <Reveal>
              <div className="text-center mb-16">
                <span className="text-[#009DE0] font-bold text-sm tracking-widest uppercase mb-2 block">Our Approach</span>
                <h3 className="font-serif text-2xl md:text-3xl text-[#334455] mb-4 font-bold">
                  さとう数理塾では、<br className="md:hidden"/>こう変えていきます
                </h3>
              </div>
            </Reveal>
                ...
                <div className="bg-white p-8 md:p-10 rounded-2xl shadow-sm border border-[#009DE0]/10 flex flex-col md:flex-row gap-8 items-center">
                  ...
                  <div className="flex-1 text-center md:text-left">
                    ...
                    <p className="text-[#334455]/80 leading-relaxed">
                      ...
                      <span className="text-[#009DE0] font-bold bg-[#009DE0]/5 px-1">最短ルートの復習計画</span>を立てます。
                    </p>
                  </div>
                </div>
              </Reveal>
                ...
                <div className="bg-white p-8 md:p-10 rounded-2xl shadow-sm border border-[#D6DE26]/30 flex flex-col md:flex-row gap-8 items-center">
                  ...
                  <div className="flex-1 text-center md:text-left">
                    ...
                    <p className="text-[#334455]/80 leading-relaxed">
                      ...
                      <span className="text-[#8C9400] font-bold bg-[#D6DE26]/10 px-1">テスト本番で使える力</span>へ変えます。
                    </p>
                  </div>
                </div>
              </Reveal>
                ...
                <div className="bg-white p-8 md:p-10 rounded-2xl shadow-sm border border-[#EA5514]/20 flex flex-col md:flex-row gap-8 items-center">
                  ...
                  <div className="flex-1 text-center md:text-left">
                    ...
                    <p className="text-[#334455]/80 leading-relaxed">
                      ...
                      <span className="text-[#EA5514] font-bold bg-[#EA5514]/5 px-1">疑問をその場で解消</span>しながら進められます。
                    </p>
                  </div>
                </div>
              </Reveal>
                 ...
                 <div className="border border-[#009DE0]/20 rounded-xl p-6 bg-white shadow-sm">
                    ...
                    <ul className="space-y-4 text-sm text-[#334455]/80">
                      <li className="flex gap-3">
                        ...
                        <span>週2回 (19:30〜)。<br/>予習に必要な過去単元はAIが自動提案。効率よくつまずきを解消しながら予習し、学校の授業を「復習の場」に変える。</span>
                      </li>
                      <li className="flex gap-3">
                        <span className="font-bold w-12 text-[#009DE0] flex-shrink-0">目標</span>
                        <span>「予習→学校の授業(復習)→定着」のサイクルを確立すること。<br/>学習科学に基づいたアプローチで、無理なく平均点以上を目指す。</span>
                      </li>
                    </ul>
                 </div>
               </Reveal>
                 ...
                 <div className="border border-[#D6DE26]/50 rounded-xl p-6 bg-white shadow-sm">
                    ...
                    <ul className="space-y-4 text-sm text-[#334455]/80">
                      <li className="flex gap-3">
                        ...
                        <span>週3回 (19:30〜)。<br/>数学は予習ペースが定着し、余裕が生まれた分、英語や理科の先取り学習にも着手。</span>
                      </li>
                      <li className="flex gap-3">
                        <span className="font-bold w-12 text-[#8C9400] flex-shrink-0">目標</span>
                        <span>数学での「貯金」を活かして全教科の評定平均を底上げし、希望する大学の指定校推薦枠を確実に掴む。</span>
                      </li>
                    </ul>
                 </div>
               </Reveal>
            ...
            <Reveal>
              <div className="mb-10">
                ...
                <h3 className="font-serif text-2xl md:text-4xl text-[#334455] mb-6 font-bold">
                  まずは、現状を整理することから<br/>始めませんか？
                </h3>
                <p className="text-[#334455]/80 leading-loose mb-8">
                  今の成績だけで、お子さんの可能性が決まるわけではありません。<br/>
                  「どこでつまずいているのか」「何をすればいいのか」がわかれば、<br className="hidden md:block"/>
                  お子さんの表情は驚くほど変わります。<br/><br/>
                  無理な勧誘は一切いたしません。<br/>
